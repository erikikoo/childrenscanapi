...
class PricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post prices_url, params: { price: { date_current: @price.date_current, user_id: @price.user_id, value: @price.value } }, as: :json
    end
  ...
  test "should update price" do
    patch price_url(@price), params: { price: { date_current: @price.date_current, user_id: @price.user_id, value: @price.value } }, as: :json
    assert_response 200
  end
